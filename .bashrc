...
# Source the Arch Linux fzf keybindings and completion scripts
source /usr/share/fzf/key-bindings.bash
source /usr/share/fzf/completion.bash

# Enforce Vim motions (hjkl)  (with Ghostty Transparency)
# Replace your previous FZF_DEFAULT_OPTS with this:
