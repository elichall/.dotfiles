...
hl.monitor({ output = "eDP-1", mode = "1920x1080@60", position = "960x2160", scale = 1 })

---------------------
---- MY PROGRAMS ----
---------------------
local terminal = "ghostty"
local tmux = 'ghostty -e bash -c "tmux has-session -t main 2>/dev/null && tmux attach-session -t main || tmux new-session -s main"'
local menu = "albert toggle"
...
hl.bind(mainMod .. " + P", hl.dsp.layout("pseudotile"))
